...
util.add_product("relic-rubber", {type="item", name="bismuth-plate", amount=1, independent_probability=0.8})
...
-- util.add_product("synthetic-rubber", {type="item", name="bismuth-plate", amount=1, independent_probability=0.8})
