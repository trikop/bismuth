...
if util.me.get_setting("bismuth-disable-pcb-solder") == not "Remove all (not reccomended)" then
    if mods["space-exploration"] then
        ...
        if util.me.get_setting("bismuth-disable-pcb-solder") == "Remove none (reccomended)" then
