...
if mods["space-exploration"] then
    ...
    util.add_ingredient("efficiency-module-4","pcb-solder", 1)
    util.add_ingredient("efficiency-module-5","pcb-solder", 1)
    util.add_ingredient("efficiency-module-6","pcb-solder", 2)
    util.add_ingredient("efficiency-module-7","pcb-solder", 4)
    util.add_ingredient("efficiency-module-8","pcb-solder", 8)
    util.add_ingredient("efficiency-module-9","pcb-solder", 10)
