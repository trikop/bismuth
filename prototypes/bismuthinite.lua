  ...
  elseif mods.Krastorio2 then
    ...
    data:extend({
      ...
      },
      {
        ...
        pictures = {
          {filename="__bismuth__/graphics/icons/bismuth-ore.png", size=64, scale=0.25},
          {filename="__bismuth__/graphics/icons/bismuth-ore-1.png", size=64, scale=0.25},
          {filename="__bismuth__/graphics/icons/bismuth-ore-2.png", size=64, scale=0.25},
          {filename="__bismuth__/graphics/icons/bismuth-ore-3.png", size=64, scale=0.25},
        },
